...
public interface WinRas {
	...
	static final Logger LOGGER = LoggerFactory.getLogger(WinRas.class);
     ...
     * structures.
     */
    @FieldOrder({"dwSize", "hrasconn", "szEntryName", "szDeviceType", "szDeviceName", "szPhonebook", "dwSubEntry", "guidEntry", "dwFlags", "luid", "guidCorrelationId", "padding"})
    public static class RASCONN extends Structure {
        ...
        public RASCONN() {
			...
			LOGGER.info("Current autocalculated dwSize: {}", dwSize);
